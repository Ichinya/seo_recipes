...
import { InformationCircleIcon, ShieldExclamationIcon, BanknotesIcon } from "@heroicons/vue/24/solid/index.js";
...
<template>
  ...
  <div class="info-box not-prose" :class="[type]">
    ...
    <ShieldExclamationIcon v-if="type == 'warning'" class="icon solid" />
    <BanknotesIcon v-else-if="type == 'error'" class="icon solid" />
