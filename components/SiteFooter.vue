<template>
  <footer class="text-sm leading-6 mt-16">
    <div class="pt-10 pb-28 border-t border-slate-200 sm:flex justify-between text-slate-500 dark:border-slate-200/5">
      ...
      </a><a href="/discord" class="hover:text-slate-500 dark:hover:text-slate-400"><span class="sr-only">Discord</span>
      ...
      </a><a href="https://t.me/tailwindcss_rus" class="hover:text-gray-500"><span
          class="sr-only">Tailwind CSS в Telegram</span>
